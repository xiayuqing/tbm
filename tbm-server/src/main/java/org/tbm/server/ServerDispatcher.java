...
public class ServerDispatcher implements Dispatcher {
    ...
    public ServerDispatcher(DataAccessor dataAccessor, CollectorPool collectorPool) {
        ...
        processors.put(PacketLite.PACKET_TYPE.HANDSHAKE, new HandshakeProcessor(dataAccessor));
        processors.put(PacketLite.PACKET_TYPE.JVM_DATA, new JvmDataCollectProcessor(dataAccessor, collectorPool));
        processors.put(PacketLite.PACKET_TYPE.BIZ_DATA, new BizDataCollectProcessor(dataAccessor, collectorPool));
