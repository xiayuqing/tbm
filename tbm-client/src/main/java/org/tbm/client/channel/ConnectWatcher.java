...
public abstract class ConnectWatcher extends ChannelInboundHandlerAdapter implements TimerTask, ChannelManager {
    ...
    public ConnectWatcher(Timer timer, ClientAgent clientAgent, String host, int port, MonitorExecutor executor) {
        this.timer = timer;
        ...
        clientAgent.connect(new ChannelFutureListener() {
            ...
            public void operationComplete(ChannelFuture future) throws Exception {
                if (future.isSuccess()) {
                    ...
                    if (null != executor) {
                        ConnectWatcher.this.executor.updateFuture(future);
                    }
                } else {
